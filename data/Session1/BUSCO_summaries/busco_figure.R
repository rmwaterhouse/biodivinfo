...
my_species <- c('SacJurei', 'SacJurei', 'SacJurei', 'SacJurei', 'Pediculus', 'Pediculus', 'Pediculus', 'Pediculus')
...
my_percentage <- c(92.2, 0.8, 1.6, 5.4, 96.4, 0.3, 2.5, 0.8)
my_values <- c(235, 2, 4, 14, 977, 3, 25, 8)
